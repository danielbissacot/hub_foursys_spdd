# 🧠 Agentes e Skills (Personas Especialistas)

Nesta pasta ficam as "Personas" da IA – perfis de especialistas com conhecimentos específicos em áreas críticas da empresa. Os agentes estão organizados por **Stack Tecnológica**.
...
- **QA Compliance Specialist**: Validação de testes e cobertura de código.

### ⚙️ Infrastructure & Ops
- **DevOps Integrator**: Configuração de CI/CD e infraestrutura.

---
> **Dica de Governança:** Sempre que iniciar um novo épico ou refatoração crítica, convide o @Agente correspondente para a conversa. Eles são os guardiões dos padrões do Hub.
