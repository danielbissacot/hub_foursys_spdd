...
# Uso do HTML
```
<div id="bse-tap" class="brad-bottom-sheet-expansive" role="dialog">
<div class="brad-bottom-sheet-expansive__header" aria-label="HeaderTitle" role="button">
  <h1 class="brad-bottom-sheet-expansive__title brad-font-subtitle-sm" aria-hidden="true">HeaderTitle</h1>
</div>
...
Agora é possível controlar o HTML do componente pelo seletor: (#bse-tap)
...
```
<div id="bse-tap" tabindex="0" class="brad-bottom-sheet-expansive" role="dialog" aria-modal="true"></div>
```
...
```
<div id="bs-304" class="brad-bottom-sheet-expansive" role="dialog">
  <div
  ...
  >
    <h1
      aria-hidden="true"
      class="brad-bottom-sheet-expansive__title brad-font-subtitle-sm"
    >
      HeaderTitle
    </h1>
  </div>
