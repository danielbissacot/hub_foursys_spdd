...
>
  <button
    ...
    onclick="LiquidCorp.BradAccordionService.toggle('#accordion-174')"
  >
    <div class="brad-accordion__title ">
      <!-- SEM TRAILING ICON -->
      <h2>Title</h2>
...
>
  <button
    role="button"
    class="brad-accordion__header brad-font-title-md"
    onclick="LiquidCorp.BradAccordionService.toggle('#accordion-51')"
  >
    <div class="brad-accordion__title ">
...
>
  <button
    role="button"
    class="brad-accordion__header brad-font-title-md"
    onclick="LiquidCorp.BradAccordionService.toggle('#accordion-180')"
  >
    <div class="brad-accordion__title ">
...
>
  <button
    role="button"
    class="brad-accordion__header brad-font-title-md"
    onclick="LiquidCorp.BradAccordionService.toggle('#accordion-406')"
  >
    <div class="brad-accordion__title ">
...
>
  <button
    role="button"
    class="brad-accordion__header brad-font-title-md"
    onclick="LiquidCorp.BradAccordionService.toggle('#accordion-301')"
  >
    <div class="brad-accordion__title ">
...
>
  <button
    role="button"
    class="brad-accordion__header brad-font-title-md"
    onclick="LiquidCorp.BradAccordionService.toggle('#accordion-267')"
  >
