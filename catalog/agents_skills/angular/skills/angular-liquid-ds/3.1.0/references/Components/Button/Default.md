...
| type | Tipo do botão string |  | type Choose option... brad-btn-primary brad-btn-secondary brad-btn-tertiary |
| hasFloating | Adicionar sombra ao botão (floating) boolean |  | FalseTrue |
| size | Tamanho do botão string |  | size Choose option... default md sm |
