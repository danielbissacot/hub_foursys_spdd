...
| iconSize | Altera tamanho do ícone string |  | iconSize Choose option... brad-icon-size-xxs brad-icon-size-sm brad-icon-size-md brad-icon-size-lg brad-icon-size-xl brad-icon-size-xxl |
| glass | Estado com glassmorphism aplicado ao botão string |  | glass Choose option... none light dark |
