...
| state | Altera o estado comportamental do card: default \| selected \| interactive \| dragged \| ribbon string | .card-brad--default | state Choose option... default selected interactive dragged ribbon |
