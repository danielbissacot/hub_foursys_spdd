...
Default
```
<div id="brad-message-239" class="brad-chat-container">
  <div
    id="brad-message-2383"
...
Indicador de digitação
```
<div id="brad-message-2412" class="brad-chat-container">
  <div
    id="brad-message-1009"
