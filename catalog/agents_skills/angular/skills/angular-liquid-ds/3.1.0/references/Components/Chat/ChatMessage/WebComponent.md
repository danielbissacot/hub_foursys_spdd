...
<brad-chat-message-container brad-num-lines="6" id="brad-container-399">
...
```
<brad-chat-message-container>
  <brad-chat-message id="brad-message-230" brad-type="outbound">
    <brad-chat-message-bubble>
      <p class="message-text">Exemplo</p>
    </brad-chat-message-bubble>
  ...
  <brad-chat-message id="brad-message-75">
    <brad-chat-message-bubble>
      <p class="message-text">Exemplo</p>
    </brad-chat-message-bubble>
...
<brad-chat-message-container id="brad-container-42">
...
<brad-chat-message-container id="brad-container-361">
...
<brad-chat-message-container id="brad-container-291">
  <brad-chat-message id="brad-m1-82">
    <brad-chat-message-bubble>
      <brad-chat-message-file-preview>
        <brad-chat-message-file-preview-image>
          <img
  ...
  <brad-chat-message id="brad-m2-395" brad-type="bot">
    <brad-chat-message-bubble>
      <brad-chat-message-file-preview>
        <brad-chat-message-file-preview-image>
          <img
