...
<div class="brad-chips brad-flex brad-flex-wrap">
  <div
    ...
    onclick="removeChip(this)"
  >
    <input id="chip-218" type="button"  />
    <label for="chip-218" class="checkmark">Label 1</label>
  </div>
  ...
  <div
    ...
    onclick="removeChip(this)"
  >
    <input id="chip-373" type="button"  />
    <label for="chip-373" class="checkmark">Label 2</label>
  </div>
  ...
  <div
    ...
    onclick="removeChip(this)"
  >
    <input id="chip-224" type="button"  />
    <label for="chip-224" class="checkmark">Label 3</label>
  </div>
</div>
