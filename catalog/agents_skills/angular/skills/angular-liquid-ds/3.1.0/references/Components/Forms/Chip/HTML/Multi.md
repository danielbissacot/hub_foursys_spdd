...
<section class="brad-m-lg-b">
  <div class="examples">
    <div class="brad-chip brad-chip--md brad-m-sm-b brad-flex">
      <input id="chip-54" type="checkbox" aria-label="Label" name="group" />
      <label for="chip-54" class="checkmark">Label 1</label>
    </div>
  </div>
  <div class="brad-chip brad-chip--md brad-flex">
      <input id="chip-54-shadow" type="checkbox" aria-label="Label" name="group" />
      <label for="chip-54-shadow" class="checkmark">Label 2</label>
    </div>
  </div>
</section>
```
