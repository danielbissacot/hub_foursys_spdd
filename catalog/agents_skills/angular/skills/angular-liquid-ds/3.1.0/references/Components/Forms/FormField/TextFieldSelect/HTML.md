...
```
<div>
  <div id="select-209" class="brad-text-field-select brad-m-lg-b">
    <p
      id="id-search-result-select-209"
      aria-live="polite"
      style="opacity: 0; position: absolute;"
    ></p>
    <label class="brad-text-field  ">
      <input
        id="my-input-select-209"
        aria-label="Campo de texto"
        type="text"
    ...
    class="leading-icon i icon-ui-placeholder complements"
  ></em>
      <small id="label-text-select-209" class="placeholder-label-field"
        >Label text</small
      >
      <span id="eprefix-select-209" class="prefix"
    >PREFIX</span
  >
      <em class="validation-icon complements"></em>
      <button class="icon-ui-placeholder arrow complements"></button>
      <span id="helper-text-select-209" class="helper-text">Helper text</span>
      <div class="brad-text-field--background"></div>
    </label>
  </div>
</div>
...
<div>
  ...
  <div id="select-92" class="brad-text-field-select brad-m-lg-b">
    <p
      id="id-search-result-select-92"
      aria-live="polite"
      style="opacity: 0; position: absolute;"
    ></p>
    <label class="brad-text-field  ">
      <input
        id="my-input-select-92"
        aria-label="Campo de texto"
        type="text"
        placeholder="Escolha uma opção"
    ...
    class="leading-icon i icon-ui-placeholder complements"
  ></em>
      <small id="label-text-select-92" class="placeholder-label-field"
        >Label text</small
      >
      <span id="eprefix-select-92" class="prefix"
    >PREFIX</span
  >
      <em class="validation-icon complements"></em>
      <button class="icon-ui-placeholder arrow complements"></button>
      <span id="helper-text-select-92" class="helper-text">Helper text</span>
      <div class="brad-text-field--background"></div>
    </label>
  </div>
...
<div>
  ...
  <div id="select-325" class="brad-text-field-select brad-m-lg-b">
    <p
      id="id-search-result-select-325"
      aria-live="polite"
      style="opacity: 0; position: absolute;"
    ></p>
    <label class="brad-text-field  ">
      <input
        id="my-input-select-325"
        aria-label="Campo de texto"
        type="text"
        placeholder="Escolha uma opção"
    ...
    class="leading-icon i icon-ui-placeholder complements"
  ></em>
      <small id="label-text-select-325" class="placeholder-label-field"
        >Label text</small
      >
      <span id="eprefix-select-325" class="prefix"
    >PREFIX</span
  >
      <em class="validation-icon complements"></em>
      <button class="icon-ui-placeholder arrow complements"></button>
      <span id="helper-text-select-325" class="helper-text">Helper text</span>
      <div class="brad-text-field--background"></div>
    </label>
  </div>
  ...
  <div id="select-313" class="brad-text-field-select brad-m-lg-b">
    <p
      id="id-search-result-select-313"
      aria-live="polite"
      style="opacity: 0; position: absolute;"
    ></p>
    <label class="brad-text-field  ">
      <input
        id="my-input-select-313"
        aria-label="Campo de texto"
        type="text"
        placeholder="Escolha uma opção"
    ...
    class="leading-icon i icon-ui-placeholder complements"
  ></em>
      <small id="label-text-select-313" class="placeholder-label-field"
        >Label text</small
      >
      <span id="eprefix-select-313" class="prefix"
    >PREFIX</span
  >
      <em class="validation-icon complements"></em>
      <button class="icon-ui-placeholder arrow complements"></button>
      <span id="helper-text-select-313" class="helper-text">Helper text</span>
      <div class="brad-text-field--background"></div>
    </label>
  </div>
