...
<section class="brad-flex brad-flex-align-items-center">
  ...
  <button
    class="brad-m-sm-l"
    onclick="LiquidCorp.BradHideTextService.getInstance({ targetSelector: '#hide-305' }).toggle(toggleEyeIcon);"
  >
    <span
...
<section class="brad-m-sm-b">
  <div class="brad-m-sm-b">
    Lorem ipsum:
    <!--Inicio do componente hide-text-->
    <span id="hide-17" class="brad-hide-text brad-m-xs-l">
      <strong>Lorem ipsum</strong>
    </span>
    <!--Fim do componente hide-text-->
  </div>
  ...
  <a
    ...
    onclick="LiquidCorp.BradHideTextService.getInstance({ targetSelector: '#hide-17' }).toggle();"
    >Mostrar/Ocultar</a
  >
</section>
```
...
<section>
  <div class="brad-m-sm-b">
    Lorem ipsum:
    <!--Inicio do componente hide-text-->
    <span id="hide-410" class="brad-hide-text brad-m-xs-l">
      <strong>Lorem ipsum</strong>
    </span>
    <!--Fim do componente hide-text-->
  </div>
  ...
  <button
    ...
    onclick="LiquidCorp.BradHideTextService.getInstance({ targetSelector: '#hide-410' }).toggle();"
  >
    Mostrar/Ocultar
  </button>
</section>
...
<section>
  <div class="brad-m-sm-b">
    Lorem ipsum:
    <!--Inicio do componente hide-text-->
    <span id="hide-30" class="brad-hide-text brad-m-xxs-l">
      <strong>Lorem ipsum</strong>
    </span>
    <!--Fim do componente hide-text-->
  </div>
  ...
  <div class="brad-flex brad-flex-row">
    <button
      ...
      onclick="LiquidCorp.BradHideTextService.getInstance({ targetSelector: '#hide-30' }).show();"
    >
      Mostrar
    </button>
    <button
      class="brad-btn brad-btn-primary"
      onclick="LiquidCorp.BradHideTextService.getInstance({ targetSelector: '#hide-30' }).hide();"
    >
      Ocultar
    </button>
  </div>
