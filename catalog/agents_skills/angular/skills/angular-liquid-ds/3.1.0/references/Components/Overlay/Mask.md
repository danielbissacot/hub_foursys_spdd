...
<section class="brad-flex brad-flex-column " brad-aria-hidden-placer>
  <button
    ...
    onclick="LiquidCorp.BradOverlayService.open('target1-157')"
  >
    Iniciar
  </button>
  <div class="brad-flex brad-flex-justify-content-center brad-m-xl">
    <button class="brad-btn brad-btn-icon brad-m-xs" id="target1-157">
      <em class="btn-icon i icon-navigation-home"></em>
    </button>

    <button class="brad-btn brad-btn-icon brad-m-xs" id="target2-25">
      <em class="btn-icon i icon-navigation-home"></em>
    </button>
  </div>
  ...
  <div class="brad-flex">
    ...
    <button
      ...
      onclick="LiquidCorp.BradOverlayService.updateTarget('target2-25')"
    >
      Próximo
    </button>
    <button
...
<canvas id="bs-99" class="brad-overlay hidden"></canvas>
```
## Copy code