...
| hasArrows | boolean | true | Controla se as setas de navegação devem ser exibidas |
...
No modo numbered, as setas de navegação (anterior e próxima) são ocultadas automaticamente em telas com largura máxima de 992px, independentemente do valor de hasArrows. Este comportamento é aplicado de forma automática pelo serviço, sem necessidade de configuração adicional.

## Abaixo segue um resumo do comportamento por modo:


| Modo | Setas em telas > 992px | Setas em telas ≤ 992px |
| --- | --- | --- |
| numbered | Exibidas | Ocultadas |
| compact | Exibidas | Exibidas |
