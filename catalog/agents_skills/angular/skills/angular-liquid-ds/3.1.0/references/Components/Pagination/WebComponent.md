...
| brad-has-arrows | boolean | true | Exibe ou oculta as setas de navegação prev e next. Ver . |
...
onPageChanges();
```
## Comportamento Responsivo das Setas

O atributo brad-has-arrows controla a exibição das setas de navegação prev e next. O valor padrão é true, portanto as setas são exibidas salvo configuração explícita de brad-has-arrows="false".

Atenção: no modo numbered, as setas são sempre ocultadas automaticamente em telas com largura ≤ 992px, independentemente do valor de brad-has-arrows. Este comportamento é aplicado de forma automática pelo serviço, sem necessidade de configuração adicional. No modo compact, as setas não são afetadas pelo breakpoint responsivo.


| Modo | brad-has-arrows | Telas > 992px | Telas ≤ 992px |
| --- | --- | --- | --- |
| numbered | true | Exibidas | Ocultadas |
| numbered | false | Ocultadas | Ocultadas |
| compact | true | Exibidas | Exibidas |
| compact | false | Ocultadas | Ocultadas |
