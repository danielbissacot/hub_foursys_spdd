...
<section>
  ...
  >
    <a
      id="popover-417"
      class="brad-text-link brad-p-sm"
      onclick=" window['popover-417'].open(); window['popover-417'].resetStepper('popover-417');"
      role="button"
      aria-label="Primeiro passo Abrir popover stepper"
      tabindex="0"
      aria-expanded="false"
  ...
  >
    ...
    >
      <div
        id="prev-button"
        class="brad-flex brad-flex-align-items-center bps-prev bps-hidden"
        onclick="window['popover-417'].prevStepper();"
        role="button"
        aria-label="Passo anterior"
      >
        <span class="icon-ui-chevron-left bps-icon"></span>
      ...
      <div
        id="next-button"
        class="brad-flex brad-flex-align-items-center bps-next"
        onclick="window['popover-417'].nextStepper();"
        role="button"
        aria-label="Próximo passo"
      >
        <a class="brad-font-link-sm"> Próximo</a>
      ...
      <div class="brad-flex bps-finish">
        ...
        <a
          ...
          onclick="window['popover-417'].close();"
          role="button"
          aria-label="Fechar tutorial"
          >Fechar tutorial</a
        >
