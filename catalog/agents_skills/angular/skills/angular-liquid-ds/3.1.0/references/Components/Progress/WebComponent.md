...
<div class="brad-flex-wrap">
    ...
    <button
      ...
      onclick="globalThis.component['pb-59'].bradCurrentProgress = 0"
    >
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
       onclick="globalThis.component['pb-59'].bradCurrentProgress = 25"
    >
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
       onclick="globalThis.component['pb-59'].bradCurrentProgress = 50"
    >
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
       onclick="globalThis.component['pb-59'].bradCurrentProgress = 75"
    >
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
       onclick="globalThis.component['pb-59'].bradCurrentProgress = 100"
    >
...
<div class="brad-flex-wrap">
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
      onclick="globalThis.component['pb-162'].bradCurrentProgress = 0"
    >
      <div class="fab-text">0%</div>
    </button>
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
       onclick="globalThis.component['pb-162'].bradCurrentProgress = 25"
    >
      <div class="fab-text">25%</div>
    </button>
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
       onclick="globalThis.component['pb-162'].bradCurrentProgress = 50"
    >
      <div class="fab-text">50%</div>
    </button>
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
       onclick="globalThis.component['pb-162'].bradCurrentProgress = 75"
    >
      <div class="fab-text">75%</div>
    </button>
    ...
    <button
      class="brad-btn brad-btn-fab-label brad-font-button brad-btn--floating brad-btn-fab-label--on-color brad-m-xs-r brad-m-xs-b"
       onclick="globalThis.component['pb-162'].bradCurrentProgress = 100"
    >
      <div class="fab-text">100%</div>
    </button>
    </div>
