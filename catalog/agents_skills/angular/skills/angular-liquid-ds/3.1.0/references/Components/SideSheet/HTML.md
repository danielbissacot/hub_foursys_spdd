...
<div id="brad-side-sheet" class="brad-side-sheet brad-side-sheet--default above-the-overlay" inert aria-hidden="true" style="display: none;" >
...
<div
  id="brad-ss-251"
  data-testid="brad-side-sheet"
  data-from="left"
  data-has-close-with-gesture="false"
  inert
  aria-hidden="true"
  style="display: none;"
>
  <button
    aria-label="Fechar SideSheet"
    role="button"
    data-ss-close="brad-ss-251"
    class="i icon-component-close-delete brad-side-sheet__close"
  ></button>

  <div class="brad-ss__content brad-m-md-t">
