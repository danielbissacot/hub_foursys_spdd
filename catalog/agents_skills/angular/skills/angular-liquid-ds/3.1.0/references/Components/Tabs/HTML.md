...
Inidicador em baixo
```
<div id="tabs-406" class="brad-tab brad-tab--indicator-bottom">
    <div
...
Indicador no topo
```
<div id="tabs-255" class="brad-tab brad-tab--indicator-top">
    <div
      id="tabpanel-1"
      role="tabpanel"
      aria-labelledby="tab-1"
...
Aninhamento
```
<div id="parent-tabs-48" class="brad-tab brad-tab--indicator-bottom ">
  ...
  >
    ...
    <div id="child-tabs-1-98" class="brad-tab brad-tab--indicator-bottom">
  ...
  >
    ...
    <div id="child-tabs-2-103" class="brad-tab brad-tab--indicator-bottom">
  ...
  >
    ...
    <div id="child-tabs-3-290" class="brad-tab brad-tab--indicator-bottom">
...
```
<div id="tabs-custom-129" class="brad-tab brad-tab--indicator-bottom">
  <div class="brad-scrollbar" role="tablist">
    <button id="custom-tab-1" type="button" role="tab" aria-selected="true">
      <span class="brad-tab__focus--js">Tab 1</span>
    </button>
