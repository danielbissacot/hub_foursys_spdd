...
<section id="is-411" class="brad-component-toggle">
   <div
    id="primary-47"
...
| --- | --- | --- | --- |
| primaryComponentService | string | - | primaryComponentService Choose option... BradBottomSheetService BradModalService BradSideSheetService |
| secondaryComponentService | string | - | secondaryComponentService Choose option... BradBottomSheetService BradModalService BradSideSheetService |