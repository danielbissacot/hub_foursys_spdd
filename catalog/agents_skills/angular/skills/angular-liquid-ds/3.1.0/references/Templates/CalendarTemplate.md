...
| --- | --- | --- |
| --brad-calendar-card-z-index | 10 | Controla o z-index do card do calendário, garantindo que ele sobreponha outros elementos da interface ao ser aberto. |


Para sobrescrever o token, aplique o valor desejado no elemento .brad-input-calendar ou em um seletor pai:

```
.brad-input-calendar {
  --brad-calendar-card-z-index: 20;
}
Copy
```
...
textFieldFirst
  .querySelctor('input')
  .addEventListener('input', inputHandler.bind(this));
textFieldSecond
  .queySelector('input')
  .addEventListener('input', inputHandler.bind(this));
...
<div class="brad-input-calendar">
  ...
  <!--CALENDARIO DENTRO DO CARD-->
  <div class="brad-card brad-card--default brad-p-lg">
    <div class="brad-calendar brad-calendar--day" id="template-calendar-216">
      <div class="brad-calendar__ui-select">
        <button class="brad-btn brad-btn-text brad-calendar__btn-year">
          <span>Button</span>
          <em class="brad-btn--icons-right i icon-ui-chevron-down"></em>
...
| --- | --- | --- | --- |
| type | Seleção do tipo de calendário string |  | type Choose option... day month year |
| date | Qual período será mostrado o calendário ao incializar object |  | date :{ mes : 0 ano : 2023 } |
| allowedPeriods | Períodos permitidos no calendário array |  | allowedPeriods :[ 0 :{...} 2 keys ] |
| selectedDates | Inicia marcando alguma(s) data(s) array |  | selectedDates :[ ] |
...
<div class="brad-inputs-align">
  <div class="brad-input-calendar">
    ...
    <!--CALENDARIO DENTRO DO CARD-->
    <div class="brad-card brad-card--default brad-p-lg">
      <div class="brad-calendar brad-calendar--day" id="template-calendar-421">
        <div class="brad-calendar__ui-select">
          <button class="brad-btn brad-btn-text brad-calendar__btn-year">
            <span>Button</span>
            <em class="brad-btn--icons-right i icon-ui-chevron-down"></em>
