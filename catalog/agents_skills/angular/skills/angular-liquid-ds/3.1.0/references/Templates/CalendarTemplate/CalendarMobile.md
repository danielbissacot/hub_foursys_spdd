...
# Exemplo
```
<label id="text-field-289" class="brad-text-field  brad-m-md-b">
    <input
...
>
  ...
  ></em>
    ...
    <div class="brad-calendar brad-calendar--modal" id="calendar-99">
      <div class="brad-calendar__ui-select">
        <button class="brad-btn brad-btn-text brad-calendar__btn-year">
          <span>Button</span>
          <em class="brad-btn--icons-right i icon-ui-chevron-down"></em>
...
| withInterval | Intervalo entre duas datas boolean |  | withInterval Choose option... true false |