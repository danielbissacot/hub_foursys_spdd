...
| --- | --- | --- | --- |
| theme | Altera segmento dos estilos string |  | theme Choose option... brad-theme-classic brad-theme-private brad-theme-exclusive brad-theme-prime brad-theme-corporate brad-theme-expresso brad-theme-next brad-theme-agora brad-theme-afluentes |
| color | Altera cor do fundo com classe de gradientes dos utilitários string | brad-color-primary-gradient-135 | color Choose option... brad-color-primary-gradient-135 brad-color-secondary-gradient-135 |
| showButton | Altera segmento dos estilos boolean |  | showButton Choose option... true false |