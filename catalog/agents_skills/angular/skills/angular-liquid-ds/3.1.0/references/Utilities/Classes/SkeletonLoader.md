...
| size | Altera a altura do elemento string | sm | size Choose option... xxs xs sm md lg xl xxl |
| shape | Altera a forma do elemento string | circle | shape Choose option... circle pill rounded flat |