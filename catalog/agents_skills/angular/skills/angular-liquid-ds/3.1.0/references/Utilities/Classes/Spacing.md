...
| --- | --- | --- | --- |
| spacingSize | Altera o tamanho de espaçamento string | - | spacingSize Choose option... none -xxs -xs -sm -md -lg -xl -xxl |
| spacingDirection | Altera a direção dos espaçamentos string | - | spacingDirection Choose option... -t -b -l -r -x -y |