...
<div class="search-container">
  ...
  <div role="listbox" class="brad-dropdown__dropdown-content brad-padding-xs">
    <button
      role="option"
...
✅ Nesta documentação, o tipo demonstrado é o dropdown, no qual os resultados da busca aparecem logo abaixo do campo de busca em um menu suspenso, mas sem alterar o layout da página. Esse comportamento sobrepõe os elementos abaixo, mas não afeta o restante da interface.
...
| --- | --- | --- | --- |
| targetSelector | string | N/A | #ID ou .classe vinculado ao HTML do componente |
...
<section>
  <p class="brad-m-xl-b ">
    ...
    <i>Apple Pay, Cartão virtual, Click to Pay, Aviso de viagem, Bloqueio temporário, Compras por aproximação, Dados do cartão, Ordenar cartões, Opções de fatura, Ver senha, Cartão adicional, Contestação de compras, Promoções, Seguro do cartão</i>.
  </p>
