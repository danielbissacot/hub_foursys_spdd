...
Ao tocar no campo de busca o usuário realiza a busca na mesma tela que ele está, e os resultados aparecem em baixo do campo.
...
class="brad-text-field-search brad-dropdown brad-dropdown--down-left brad-m-md-b"
>
<div class="search-container">
  ...
  <div
    id="id-brad-dropdown"
    role="listbox"
    class="brad-dropdown__dropdown-content brad-padding-xs"
  >
    <button
      role="option"
...
✅ Nesta documentação, o tipo demonstrado é o static, no qual os resultados da busca aparecem apenas quando há correspondência com o texto digitado, sendo exibidos diretamente abaixo do campo de entrada, sem sobrepor o conteúdo da página.
...
<article>
  <p class="brad-m-xl-b ">
    ...
    <em>
      Apple Pay, Cartão virtual, Click to Pay, Aviso de viagem, Bloqueio temporário, Compras por aproximação, Dados do cartão, Ordenar cartões, Opções de fatura, Ver senha, Cartão adicional, Contestação de compras, Promoções, Seguro do cartão
    </em>
    .
  </p>
  ...
  <div
    id="filter-407"
    data-search="static"
    class="brad-text-field-search brad-text-field-search--static"
  >
    <div class="search-container">
  ...
  ></button>
    ...
    <div class="static-search brad-m-lg-t">
  ...
  <div class="brad-alert brad-alert--warning brad-m-lg-t">
