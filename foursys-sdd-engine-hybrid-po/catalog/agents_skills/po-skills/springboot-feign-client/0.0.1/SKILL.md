...
@Slf4j
@Configuration
@EnableFeignClients(basePackages = "br.com.bradesco.projeto.adapter.output.client")
  ...
  client:
    config:
      default:
        ...
        readTimeout: 15000
        loggerLevel: none
        retryer: com.bradesco.config.CustomRetryer
  httpclient:
    enabled: true
    max-connections: 500
...
import br.com.bradesco.projeto.adapter.output.client.dto.request.CriarUsuarioRequest;
import br.com.bradesco.projeto.adapter.output.client.dto.response.UsuarioApiResponse;
...
```java
package br.com.bradesco.projeto.adapter.output.config;
