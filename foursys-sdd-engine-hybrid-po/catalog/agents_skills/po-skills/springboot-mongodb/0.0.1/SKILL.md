...
**📖 Consulte**: [references/REPOSITORY_INTEGRATION.md](references/REPOSITORY_INTEGRATION.md) para estrutura detalhada com exemplos
...
**📖 Consulte**: [references/REPOSITORY_INTEGRATION.md](references/REPOSITORY_INTEGRATION.md) para detalhes
...
**📖 Consulte**: [references/MONGOTEMPLATE_USAGE.md](references/MONGOTEMPLATE_USAGE.md) para detalhes
...
**📖 Consulte**: [references/QUERY_METHODS.md](references/QUERY_METHODS.md) para exemplos avançados
...
```java
@Configuration
@EnableMongoRepositories(basePackages = "br.com.bradesco.adapter.output.mongodb")
...
**📖 Consulte**: [references/TRANSACTIONS.md](references/TRANSACTIONS.md) para detalhes e boas práticas
...
**📖 Consulte**: [references/PAGINATION.md](references/PAGINATION.md) para estratégias avançadas
...
- **[REPOSITORY_INTEGRATION.md](references/REPOSITORY_INTEGRATION.md)** - Implementação completa com arquitetura hexagonal
- **[MONGOTEMPLATE_USAGE.md](references/MONGOTEMPLATE_USAGE.md)** - MongoTemplate para queries complexas
- **[QUERY_METHODS.md](references/QUERY_METHODS.md)** - Queries customizadas com @Query, JSON e SpEL
- **[TRANSACTIONS.md](references/TRANSACTIONS.md)** - Configuração e boas práticas de transações
- **[PAGINATION.md](references/PAGINATION.md)** - Estratégias eficientes de paginação
