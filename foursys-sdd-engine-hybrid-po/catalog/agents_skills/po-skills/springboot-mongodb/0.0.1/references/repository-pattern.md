...
```java
package br.com.bradesco.contacorrente.adapter.output.mongodb.entity;
...
```java
package br.com.bradesco.contacorrente.adapter.output.mongodb.repository;
...
```java
package br.com.bradesco.contacorrente.adapter.output.mongodb.mapper;
