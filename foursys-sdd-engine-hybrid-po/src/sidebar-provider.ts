...
<body>
    ...
    <!-- PO AGENT LAUNCHER -->
    <div style="border-top:1px solid #3c3c3c;padding:7px 6px;flex-shrink:0;margin-top:auto">
        <div style="font-size:8px;text-transform:uppercase;letter-spacing:.5px;color:#6a6a6a;text-align:center;margin-bottom:5px">Agentes de Negócio</div>
        <button
            onclick="sendAction('OpenPOPanel')"
            style="width:100%;padding:7px 10px;background:rgba(255,107,0,.12);border:1px solid rgba(255,107,0,.35);
                   ...
                   display:flex;align-items:center;gap:7px;transition:background .15s;margin-bottom:5px"
